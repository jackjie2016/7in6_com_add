 ...
 * by shopjl 网店技术交流中心  www.7in6.com 开发
...
class member_cardControl extends BaseHomeControl{
	...
	public function indexOp(){
		...
		$member_info = $model->table('member')->field('member_id, member_avatar,member_name, member_truename, member_sex, member_email, member_qq, member_ww, member_areainfo, member_birthday, member_privacy, member_exppoints')->find($uid);
		...
		$data['avatar']		= getMemberAvatar($member_info['member_avatar']);
