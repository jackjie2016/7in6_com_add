      ...
      <tbody>
        <tr>
          <td><select name="search_field_name" >
             ...
             <!--微信登陆--> <option <?php if($output['search_field_name'] == 'nickname'){ ?>selected='selected'<?php } ?> value="nickname">微信昵称</option>
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          ...
          <!--用户关系-->
           <th class="align-center">下级用户数</th>
          <!--用户关系-->
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="w24"><?php echo  $v['member_id']; ?></td>
          <td class="w48 picture"><div class="size-44x44"><span class="thumb size-44x44"><i></i>
                      <img src="<?php  echo getMemberAvatar($v['member_avatar']);?>"  onload="javascript:DrawImage(this,44,44);"/>
                </span></div></td>
          <td><p class="name"><strong><?php   if($v['wecha_id']){ echo $v['nickname']; }else{  echo $v['member_name'];   } ?></strong>(<?php echo $lang['member_index_true_name']?>: <?php echo $v['member_truename']; ?>)</p>
            ...
            <!--用户关系-->
            <td class="align-center"><a href="index.php?act=member&op=member&member_id=<?php echo $v['member_id']; ?>">(<?php echo $v['zcount1']; ?>)</a></td>
           <!--用户关系-->
