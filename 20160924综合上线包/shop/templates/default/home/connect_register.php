    ...
    <div class="nc-login-content">
      <form name="register_form" id="register_form" method="post" action="index.php?act=connect&op=register">
        ...
        <dl>
          <dt>&nbsp;</dt>
          <dd>
            <input type="submit" name="submit" value="<?php echo $lang['login_register_enter_now'];?>" class="submit fl" style="color:#999;width:78px"/>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="index.php" style="margin-top:9px;line-height:37px"><?php echo $lang['home_qqconnect_homepage']; ?></a></span>
            <label></label>
          </dd>
        </dl>
      </form>
