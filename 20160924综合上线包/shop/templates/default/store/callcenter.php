...
<div class="ncs-message-bar">
  <div class="default">
<!--    <h5 style="text-align:center"><?php echo $output['store_info']['store_name']; ?></h5>-->
    <h5 style="margin-left:58px;font-size:15px"><?php echo 在线接待 ?></h5> 
  ...
  <div class="service-list" store_id="<?php echo $output['store_info']['store_id'];?>" store_name="<?php echo $output['store_info']['store_name'];?>">
    ...
    <dl>
      <!--<?php echo $lang['nc_message_presales'];?></dt>-->
      <?php foreach($output['store_info']['store_presales'] as $val){?>
      <dd><span><?php echo $val['name']?></span><span>
        <?php if($val['type'] == 1){?>
        <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $val['num'];?>&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:<?php echo $val['num'];?>:41"  style=" vertical-align: middle;"/></a>
        <?php }elseif($val['type'] == 2){?>
        <!--<a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&amp;uid=<?php echo $val['num'];?>&site=cntaobao&s=1&charset=<?php echo CHARSET;?>"  ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $val['num'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['nc_message_me'];?>"  title="google浏览器不支持此功能"/></a>-->
        <a target="_blank" href=" http://amos.alicdn.com/msg.aw?v=2&uid=<?php echo $val['num'];?>&site=cnalichn&s=1&charset=<?php echo CHARSET;?>"  ><img border="0" src="http://amos.alicdn.com/online.aw?v=2&uid=<?php echo $val['num'];?>&site=cnalichn&s=1&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['nc_message_me'];?>"  title="google浏览器不支持此功能"/></a>
    ...
    <!--<dl>-->
      <!--<?php echo $lang['nc_message_service'];?></dt>-->
      <?php foreach($output['store_info']['store_aftersales'] as $val){?>
      <dd><span><?php echo $val['name']?></span><span>
        <?php if($val['type'] == 1){?>
        <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $val['num'];?>&site=qq&menu=yes" target="_blank"><img border="0" src="http://wpa.qq.com/pa?p=2:<?php echo $val['num'];?>:41" alt="<?php echo $lang['nc_message_me'];?>" style=" vertical-align: middle;"></a>
        <?php }elseif($val['type'] == 2){?>
        <!--<a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&amp;uid=<?php echo $val['num'];?>&site=cntaobao&s=1&charset=<?php echo CHARSET;?>" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $val['num'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['nc_message_me'];?>" title="google浏览器不支持此功能"/></a>-->
        <a target="_blank" href=" http://amos.alicdn.com/msg.aw?v=2&uid=<?php echo $val['num'];?>&site=cnalichn&s=1&charset=<?php echo CHARSET;?>" ><img border="0" src="http://amos.alicdn.com/online.aw?v=2&uid=<?php echo $val['num'];?>&site=cnalichn&s=1&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['nc_message_me'];?>" title="google浏览器不支持此功能"/></a>
        <?php }elseif($val['type'] == 3){?>
