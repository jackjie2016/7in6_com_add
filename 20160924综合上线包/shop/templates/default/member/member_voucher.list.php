    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $val['store_name'];?>（<?php echo $lang['voucher_voucher_usecondition'];?>：<?php echo $lang['voucher_voucher_usecondition_desc'].$val['voucher_limit'].$lang['currency_zh'];?>）</dd>
          </dl></td>
        ...
        <td class="ncm-table-handle"><?php if ($val['voucher_state'] == '1'){?>
          ...
          <span><a href="/" class="btn-green" ><i class="icon-shopping-cart"></i><p>使用</p></a></span>
