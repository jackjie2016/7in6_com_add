    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><?php echo '第一级和第二级分类可以上传图片，建议第一级用16px * 16px，第二级用30px*30px超出后自动隐藏';?></td>
        </tr> 
        ...
        <!--首页分类banner_start-->
        <tr>
          <td colspan="2" class="required"><label for="banner_pic"><?php echo '分类banner大图片';?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo $output['class_array']['banner_pic'];?>"></div>
            </span>
            ...
            <input name="banner_pic" type="file" class="type-file-file" id="banner_pic" size="30" hidefocus="true" nc_type="change_banner_pic">
            </span>
          </td>
          <td class="vatop tips"><?php echo '只有第一级分类可以上传图片，建议用1920px * 500 px，超出后自动隐藏';?></td>
        </tr>
         
      <!--banner链接-->
        <tr class="noborder">
          <td colspan="2" class="required"><label   for="banner_link"><?php echo "banner链接";?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['class_array']['banner_link'];?>" name="banner_link" id="banner_link"  class="txt"></td>
          <td class="vatop tips">请输入带http:// </td>
        </tr>
           
       
        <!--banner小广告1-->
        <tr>
          <td colspan="2" class="required"><label for="banner_ad_1"><?php echo '分类banner小广告1';?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo $output['class_array']['banner_ad_1'];?>"></div>
            </span><span class="type-file-box">
            <input type='text' name='textfield3' id='textfield3' class='type-file-text' />
            <input type='button' name='button3' id='button3' value='' class='type-file-button' />
            <input name="banner_ad_1" type="file" class="type-file-file" id="banner_ad_1" size="30" hidefocus="true" nc_type="change_banner_ad_1">
            </span></td>
          <td class="vatop tips"><?php echo '只有第一级分类可以上传图片，建议用190px * 240 px，超出后自动隐藏';?></td>
        </tr>
        
            <!--banner小广告1链接-->
         <tr class="noborder">
          <td colspan="2" class="required"><label   for="banner_ad_1_link"><?php echo "分类banner小广告1链接";?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['class_array']['banner_ad_1_link'];?>" name="banner_ad_1_link" id="banner_ad_1_link"  class="txt"></td>
          <td class="vatop tips">请输入带http:// </td>
        </tr>
            
            <!--banner小广告2-->
        <tr>
          <td colspan="2" class="required"><label for="banner_ad_2"><?php echo '分类banner小广告2';?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo $output['class_array']['banner_ad_2'];?>"></div>
            </span><span class="type-file-box">
            <input type='text' name='textfield4' id='textfield4' class='type-file-text' />
            <input type='button' name='button4' id='button4' value='' class='type-file-button' />
            <input name="banner_ad_2" type="file" class="type-file-file" id="banner_ad_2" size="30" hidefocus="true" nc_type="change_banner_ad_2">
            </span></td>
          <td class="vatop tips"><?php echo '只有第一级分类可以上传图片，建议用190px * 240 px，超出后自动隐藏';?></td>
        </tr>
          ...
          <!--banner小广告2链接-->
         <tr class="noborder">
          <td colspan="2" class="required"><label   for="banner_ad_2_link"><?php echo "分类banner小广告2链接";?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['class_array']['banner_ad_2_link'];?>" name="banner_ad_2_link" id="banner_ad_2_link"  class="txt"></td>
          <td class="vatop tips">请输入带http:// </td>
        </tr>
...
<!--手机分类新增广告图、分类图标start-->
        <tr>
          <td colspan="2" class="required"><label for="banner_mobile"><?php echo '手机分类banner';?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo $output['class_array']['banner_mobile'];?>"></div>
            </span><span class="type-file-box">
            <input type='text' name='textfield5' id='textfield5' class='type-file-text' />
            <input type='button' name='button5' id='button5' value='' class='type-file-button' />
            <input name="banner_mobile" type="file" class="type-file-file" id="banner_mobile" size="30" hidefocus="true" nc_type="change_banner_mobile">
            </span></td>
          <td class="vatop tips"><?php echo '只有第一级分类可以上传图片，建议用 520px * 185 px，超出后自动隐藏';?></td>
        </tr>
        
        
                <tr>
          <td colspan="2" class="required"><label for="class_logo"><?php echo '手机分类logo';?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo $output['class_array']['class_logo'];?>"></div>
            </span><span class="type-file-box">
            <input type='text' name='textfield6' id='textfield6' class='type-file-text' />
            <input type='button' name='button6' id='button6' value='' class='type-file-button' />
            <input name="class_logo" type="file" class="type-file-file" id="class_logo" size="30" hidefocus="true" nc_type="change_class_logo">
            </span></td>
          <td class="vatop tips"><?php echo '只有第三分类可以上传图片，建议用119px * 102 px，超出后自动隐藏';?></td>
        </tr>
...
$(document).ready(function(){
	...
	$("#pic").change(function(){
		...
		$("#textfield2").val($(this).val());
                    ...
                    //幻灯片广告1
                  $("#banner_ad_1").change(function(){
		$("#textfield3").val($(this).val());
	});  
                  //幻灯片广告2
                  $("#banner_ad_2").change(function(){
		$("#textfield4").val($(this).val());
	});
        
                   //手机分类banner
                  $("#banner_mobile").change(function(){
		$("#textfield5").val($(this).val());
	});
                       //手机分类logo
                  $("#class_logo").change(function(){
