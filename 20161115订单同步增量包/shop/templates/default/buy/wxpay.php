...
<!--<img src="../shop/templates/default/images/payment/getWxImage.jpg">-->
	...
	<script type="text/javascript">
		...
		function ajax_order(){
			...
			$.ajax({
                        ...
                        url: "/index.php?act=payment&op=is_wxpay",
		        ...
		        success: function(result) {
					...
					if(result.data == '20'){
						...
						location.href = "<?php echo $output['shop_site_url'];?>/index.php?act=buy&op=pay_ok&pay_sn="+pay_sn+"&pay_amount="+<?php echo ncPriceFormat($output['total_fee'])?>;
