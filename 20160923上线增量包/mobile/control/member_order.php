...
class member_orderControl extends mobileMemberControl {
    ...
    public function order_listOp() {
        ...
        //$this->page 返回订单 数量
        /*edit by peiyu start*/
        $order_list_array = $model_order->getNormalOrderList($condition, '', '*', 'order_id desc','', array('order_goods','order_common','store'));
        /*edit by peiyu stop*/
    ...
    */
    public function order_infoOp(){
    	...
    	foreach ($order_info['extend_order_goods'] as $key => $value){
     		//给商品图片加上链接
    		$value['goods_image_url'] = cthumb($value['goods_image'], 240, $order_info['store_id']);
