	...
	<div class="main_panel" id="js_mainPanel">
		...
		<ul class="bar-bottom">
			...
			<li class="service">
				...
				<div class="tooltip"><a target="_blank"  href="http://amos.alicdn.com/msg.aw?v=2&amp;uid=meinongebox:包装君&amp;site=cnalichn&amp;s=1&amp;charset=UTF-8" id="chat_show_user" class="chat" ><a style="color:white;" title="google不支持">阿里旺旺</a><i id="new_msg" class="new_msg" style="display:none;"></i></a></div>
			</li>
