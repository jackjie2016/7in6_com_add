  ...
  <form method="get">
    ...
    <table class="search-form">
      ...
      <tr>
        ...
        <td><a href="index.php?act=store_voucher&op=voucher_offline_use">实体店核销卡卷</a></td>
  ...
  <table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="goods-price">￥<?php echo $val['voucher_t_price'];?> <?php if($val['is_random']==1){echo " ~ " . $val['voucher_t_price_max'];}?></td>
		...
		<td>wap端：<?php echo WAP_SITE_URL;?>/tmpl/voucher.html?voucher_id=<?php echo $val['voucher_t_id']?>
                <!--<br/>web端：<?php echo SHOP_TEMPLATES_URL;?>/tmpl/voucher.html?voucher_id=<?php echo $val['voucher_t_id']?></td>-->
