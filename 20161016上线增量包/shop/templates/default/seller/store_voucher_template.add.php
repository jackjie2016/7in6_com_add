                    ...
                    <div class="promote-descs">
                        ...
                        <div class="block">
                            <div class="block-item clearfix">
                                ...
                                <span>
                                特别声明：<br>
                                    1.本代金券仅限在去印咯商城（www.7in6.com）使用。
                                    <br>
                                    2.本代金券只能在符合条件的情况下使用。
                                    <br>
                                    3.本代金券不设找零，不可兑现现金。可以与其他优惠同时使用。
                                    <br>
                                    4.红包抵扣部分的货款可以开具发票。
                                    <br>
                                    5.本活动未尽事宜以网站平台宣传为准，最终解释权归去印咯商城。
                                </span>
...
<!--   -->
           <div class="app-attr">
            <!--edit by peiyu 20160829 start-->
            <dl>
    
                <dt style="width: 100%;text-align:left;padding-left:17px;color:red">
                
                   请按照以下规则增加代金券：&nbsp; 1：通用代金券：代金券种类请选择通用代金券，代金券所属选择<br/>
                   全部,消费金额填写0；&nbsp; 2：全店满额代金券：代金券种类请选择抵扣代金券，代金券所属选择全<br/>
                   部，消费金额根据活动需求填写；&nbsp; 3：特殊类目代金券：代金券种类请选择通用抵扣代金券，代<br/>
                   金券所属自己需要的类目（不允许选择全部，切记）,代金券金额可以写0,也可以写特定数字（前<br/>
                   者特殊通用代金券，后者属于特殊满额代金券）
                </dt>
    
            </dl>
            <!--edit by peiyu 20160829 stop-->
            <dl>
...
<!--    <?php if ($output['isOwnShop']) { ?>
    ...
    <?php } ?>-->
              ...
              <!--edit by peiyu start 增加代金券使用的结束时间-->
              <dt><i class="required">*</i><em class="pngFix"></em>有效期结束时间:</dt>
    
              <dd>
                    <input type="text" class="text w70" id="txt_template_use_end_date" name="txt_template_use_end_date" value="<?php  if(!empty($output['t_info']['voucher_u_end_date'])){echo date("Y-m-d",$output['t_info']['voucher_u_end_date']);} ?>" readonly><em class="add-on"><i class="icon-calendar"></i></em>
              </dd>
              <!--edit by peiyu stop 增加代金券使用的结束时间-->
            </dl>
...
$(document).ready(function(){
	...
	$('#txt_template_startdate').datepicker();
        $('#txt_template_use_end_date').datepicker();
