...
<div class="design">
    ...
    <div class="design_goods"> 
        <div class="goods_content">
            <a href='<?php echo SHOP_SITE_URL?>/item-1973.html'>
        ...
        <div class="goods_content">
			<a href='<?php echo SHOP_SITE_URL?>/item-1965.html'>
        ...
        <div class="goods_content" style="margin-right:0px">
			<a href='<?php echo SHOP_SITE_URL?>/item-1974.html'>
        ...
        <div class="goods_content">
			<a href='<?php echo SHOP_SITE_URL?>/item-1958.html'>
        ...
        <div class="goods_content">
			<a href='<?php echo SHOP_SITE_URL?>/item-1966.html'>
        ...
        <div class="goods_content" style="margin-right:0px">
			<a href='<?php echo SHOP_SITE_URL?>/item-1983.html'>
        ...
        <div class="goods_content">
			<a href='<?php echo SHOP_SITE_URL?>/item-1972.html'>
        ...
        <div class="goods_content">
			<a href='<?php echo SHOP_SITE_URL?>/item-1964.html'>
        ...
        <div class="goods_content" style="margin-right:0px">
			<a href='<?php echo SHOP_SITE_URL?>/item-1961.html'>
        ...
        <div class="goods_content">
			<a href='<?php echo SHOP_SITE_URL?>/item-1969.html'>
        ...
        <div class="goods_content">
			<a href='<?php echo SHOP_SITE_URL?>/item-1978.html'>
        ...
        <div class="goods_content" style="margin-right:0px">
			<a href='<?php echo SHOP_SITE_URL?>/item-1979.html'>
