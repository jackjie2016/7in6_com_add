...
<!-- <meta property="qc:admins" content="2557766007674610061667313230707222237" /> -->
<meta property="qc:admins" content="3242627577631323070637576233" />
<meta property="wb:webmaster" content="442953fb04de3018" />
<title><?php echo $output['html_title'];?></title>
<meta name="keywords" content="<?php echo $output['seo_keywords']; ?>" />
<meta name="description" content="<?php echo $output['seo_description']; ?>" />
<link rel="short icon" type="image/x-icon" href="<?php echo SHOP_TEMPLATES_URL;?>/images/icon1.png">
...
<link rel="shortcut icon" href="<?php echo dirname(SHOP_SITE_URL);?>/favicon.ico" />
...
$(".category ul.menu").find("li").each(
    ...
    function() {
      $(this).hover(function(){
        var cat_id = $(this).attr("cat_id");
        var menu = $(this).find("div[cat_menu_id='"+cat_id+"']");
        $(menu).animate({left: '210px'}, 100);
        $(menu).css({'opacity':'1'});
      },function(){
        var cat_id = $(this).attr("cat_id");
        var menu = $(this).find("div[cat_menu_id='"+cat_id+"']");
        $(menu).stop(true,false).animate({left: '200px'}, 100);
        $(menu).css({'opacity':'0'});
      })
    })
/**/
...
<div class="header-wrap">
  <header class="public-head-layout wrapper d_top">
    ...
    <div class="head-ad1048"><?php echo loadadv(1048); ?></div>
        ...
        <dd>
          ...
          <div class="user-centent-menu">
            <ul>
              ...
              <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_points" class="arrow">我的抵币<i></i></a></li>
              <?php } ?>
            </ul>
          </div>
...
<nav class="public-nav-layout">
  <div class="wrapper">
    ...
    <ul class="site-menu">
      ...
      <!-- 1元购活动入口 wugangjian 20160918 START -->
      <!-- <?php if (C('groupbuy_allow')){ ?>
      <li class="d_re">
        <a href="http://www.easyboxprint1.cn/shop/index.php?act=special&op=special_detail&special_id=10" <?php if($output['index_sign'] == 'groupbuy' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <?php echo $lang['nc_groupbuy'];?></a>
        <img class="d_ab" src="<?php echo SHOP_TEMPLATES_URL;?>/images/navHot.gif">
      </li>
      <?php } ?> -->
      <!-- 1元购活动入口 wugangjian 20160918 END -->
      <!--<?php if (C('groupbuy_allow')){ ?>
      <li class="d_re">
        <a href="<?php echo urlShop('show_groupbuy', 'index');?>" <?php if($output['index_sign'] == 'groupbuy' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <?php echo $lang['nc_groupbuy'];?></a>
        <img class="d_ab" src="<?php echo SHOP_TEMPLATES_URL;?>/images/navHot.gif">
      </li>
      <?php } ?>
      ...
      <li class="d_re">
        <a href="<?php echo urlShop('pointshop', 'index');?>" <?php if($output['index_sign'] == 'pointshop' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <?php echo $lang['nc_pointprod'];?></a>
        <img class="d_ab" src="<?php echo SHOP_TEMPLATES_URL;?>/images/navNew.gif">
      </li>
      <?php } ?>
     <?php if (C('cms_isuse')){ ?>
     <li><a href="<?php echo urlShop('special', 'special_list');?>" <?php if($output['index_sign'] == 'special' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> 专题</a></li>
      ...
      <?php }?>
      <?php }?>
      <!--edit by peiyu start 新增专题界面-->
      <li class="d_re">
        <a href="<?php echo urlShop('design', 'design');?>" <?php if($output['index_sign'] == 'design' && $output['index_sign'] != '0') {echo 'class="current"';} ?>>设计服务</a>
      </li>
      <!--edit by peiyu stop 新增专题界面-->
    </ul>
  </div>
</nav>
