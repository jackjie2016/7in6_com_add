    ...
    <div class="ncm-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><span><?php echo $output['order_info']['extend_store']['area_info'];?></span><span><?php echo @$output['order_info']['extend_store']['store_address'];?></span></dd>-->
          <dt><?php echo $lang['member_show_order_receiver'].$lang['nc_colon'];?></dt>
        ...
        <dl>
          ...
          <dd>
            ...
            <?php 
            $str="";
            foreach ((array)$output['order_info']['extend_order_common']['invoice_info'] as $key => $value){
            $str=$str.$value;
            $str=$str;
            }
            if($str==''){?>
        ...
        <dl>
          ...
          <dd><?php if($output['order_info']['extend_order_common']['order_message']===""){echo '无';}else{echo $output['order_info']['extend_order_common']['order_message']; }?></dd>
        </dl>
        <dl class="line">
        ...
        <dl>
          ...
          <dd><?php echo $output['order_info']['extend_store']['store_name']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
            ...
            <div class="msg"> <span member_id="<?php echo $output['order_info']['extend_store']['member_id'];?>"></span>
              ...
              <a target="_blank" href=" http://amos.alicdn.com/msg.aw?v=2&amp;uid=meinongebox:包装君&amp;site=cnalichn&amp;s=1&amp;charset=UTF-8"  class="vm" ><img border="0" src="http://amos.alicdn.com/online.aw?v=2&amp;uid=meinongebox:包装君&amp;site=cnalichn&amp;s=1&amp;charset=UTF-8" alt="点击这里给我发消息" title="google浏览器不支持此功能"  style=" vertical-align: middle;"/></a>
              <?php }?>
            </div>
          </dd>
        </dl>
      ...
      <tfoot>
        ...
        <tr>
          <th colspan="20"><dl class="ncm-store-sales">
              ...
              <?php } ?>
              <!--将代金券转化成数组，将代金券代码转化成数组-->
              <?php if(!empty($output['order_info']['extend_order_common']['voucher_code'])){ ?>
              <?php 
                    $price = explode("|",$output['order_info']['extend_order_common']['voucher_price']);
                    $code = explode("|",$output['order_info']['extend_order_common']['voucher_code']);
                    foreach($code as $k =>$vo){  
                    
              ?>
              <dd>使用了面额为 <strong><?php echo $price[$k];?></strong> 元的代金券，编码：<?php echo $vo;?></span></dd><br/>
              <?php }} ?>
            </dl>
          </th>
        </tr>
