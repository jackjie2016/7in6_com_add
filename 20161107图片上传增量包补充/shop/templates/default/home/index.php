...
<style type="text/css">
    ...
    .tanceng_tp1{position:absolute;top:30px;left:64%;width:30px;height:29px;}
    /*edit by peiyu stop*/
</style>
<div class="clear"></div>
...
<div id='pop_layer' >
    <div class='pop_layer_all'>
        <a href="/index.php?act=special&op=special_detail&special_id=10">
            <img class="tanceng_tp" src="<?php echo SHOP_TEMPLATES_URL;?>/images/PC-2.png" style="width:468px; height:363px; margin-top:60px">
        </a>
...
<div class="home-sale-layout3">
    ...
    <div class="layout3_right">
        <div class="layout3_top">
            <div id="4" class="layout3_top1">
		       <!--<script type="text/javascript">fillAdSpace("4");</script>-->
               <a href="<?php echo SHOP_SITE_URL?>/item-145.html"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/bane3_002.jpg" ></a>
            </div>
